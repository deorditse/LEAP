...
String urlMainApiUrl = "www.alphavantage.co";
String apiKey = 'SVI0WQPWRP0NI2YR';

Uri urlMain({Map<String, dynamic>? queryParameters, required String urlPath}) =>
    Uri.https(urlMainApiUrl, urlPath, queryParameters);
...
class Generic {
  ...
  static T fromJson<T>(Map<String, dynamic> json) {
    if (T == AboutCompanyModel) {
      return AboutCompanyModel.fromJson(json) as T;
    } else {
